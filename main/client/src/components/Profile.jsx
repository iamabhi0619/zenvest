...
function Profile({ data }) {
  return (
    <div className="relative w-44 md:w-60 h-64 md:h-96 mx-2 overflow-hidden shadow-[0_30px_30px_-20px_rgba(0,0,0,1),_inset_0_0_0_1000px_rgba(67,52,109,0.6)] rounded-[15px] flex flex-col justify-center items-center group">
      ...
      <div className="absolute bottom-9 w-full flex flex-col justify-center items-center transition-all duration-500 ease-in-out group-hover:opacity-0 opacity-100">
        <h3 className="text-white md:text-2xl font-medium text-center uppercase tracking-wider mb-2 transition-transform duration-500">
          {data.name}
          <br />
          <span className="md:text-xl font-light not-italic">{data.post}</span>
        </h3>
      </div>
      <div className="absolute bottom-0 w-full h-[160px] flex flex-col justify-center items-center bg-opacity-60 bg-black rounded-b-[15px] transition-all duration-500 ease-in-out group-hover:opacity-100 opacity-0 group-hover:bottom-0">
        <h3 className="text-white md:text-2xl font-medium text-center uppercase tracking-wider mb-2 transition-transform duration-500 group-hover:translate-y-0 translate-y-10 opacity-0 group-hover:opacity-100">
          {data.name}
          <br />
          <span className="md:text-xl font-light not-italic">{data.post}</span>
        </h3>
